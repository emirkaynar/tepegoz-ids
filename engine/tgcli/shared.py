...
░░░███░    ███░░███░░███░░███ ███░░███ ███░░███ ███░░███ ░█░░░░███ 
  ...
  Tepegoz watches your network traffic for suspicious activity
  like port scans, brute force attacks, and data floods - without
  looking at private content. Think of it as a security camera
  for your internet connection.

  QUICK START (3 steps)
  ---------------------

  1. Tell Tepegoz which network interface to monitor:

       sudo tepegoz sensor iface set <your-interface>

     Not sure which one? Run: ip link
     (Usually "eth0" for wired or "wlan0" for Wi-Fi)

  2. Set up the dashboard (Grafana + InfluxDB):
